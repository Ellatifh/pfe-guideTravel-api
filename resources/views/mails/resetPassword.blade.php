...
<td class="header" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 25px 0; text-align: center;">
        <a href="http://pfe-backoffice-ng.herokuapp.com/" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #bbbfc3; font-size: 19px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 #ffffff;">
        <img src="{{ url('/img/logo.jpeg') }}" alt="logo" style="width:170px;height:80px">
        </a>
    </td>
</tr>
<!-- Email Body --><tr>
...
<h1 style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #2F3133; font-size: 19px; font-weight: bold; margin-top: 0; text-align: left;">Dear {{$data['username']}}</h1>
<p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">It looks like we've received a password reset request for the <b>Visit-Morocco</b> application account tied to this email ,  We've generated new random password</p>
...
<td align="center" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
<p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; line-height: 1.5em; margin-top: 0; font-size: 15px; text-align: center;">New Password: {{$data['password']}}</p>
        </td>
    </tr></table>
...
<td class="content-cell" align="center" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #aeaeae; font-size: 12px; text-align: center;">© 2020 Visit Morocco. All rights reserved.</p>
                </td>
            </tr></table>
</td>
</tr>
